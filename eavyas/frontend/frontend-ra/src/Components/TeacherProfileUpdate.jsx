...
const TeacherProfileUpdate = () => {
    ...
    const[userData,setuserData]=useState(
      ...
      const updatedata=(event)=>{
        ...
        try{
          axios.put('http://localhost:8000/teacher/'+loggeduser+'/',userFormData).then((response)=>{
        ...
        <div className='row'>
            <section className='col-md-9'>
                ...
                <hr/>
                   ...
                   <button className='btn btn-outline-primary' onClick={()=>{window.location.href="/teacher-profile"}}>Back</button>
