          ...
          <div className="card">
            ...
            <div className="card-body">
              <form>
                ...
                <div className="mb-3">
                  <label htmlFor="ans1" className="from-label">
                    Ans 1
                  </label>
                  <input
                    type="text"
                ...
                <div className="mb-3">
                  <label htmlFor="ans2" className="from-label">
                    Ans 2
                  </label>
                  <input
                    type="text"
                ...
                <div className="mb-3">
                  <label htmlFor="ans3" className="from-label">
                    Ans 3
                  </label>
                  <input
                    type="text"
                ...
                <div className="mb-3">
                  <label htmlFor="ans4" className="from-label">
                    Ans 4
                  </label>
                  <input
                    type="text"
                ...
                <div className="mb-3">
                  <label htmlFor="right_ans" className="from-label">
                    Right answer
                  </label>
                  <input
                    type="text"
                ...
                <Link className="btn btn-info btn-sm ms-2" to="/quiz">
                  Back
                </Link>
              </form>
            </div>
